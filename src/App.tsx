  ...
  const projects = [
    {
      ...
      tech: ["Figma", "UI/UX"],
      figma:
        "https://www.figma.com/design/Q0ktgbwA2LrveTp4WiS3Va/UX--fault?node-id=0-1&t=osdaff9GLE4wUle8-1",
    ...
    },
    {
      ...
      tech: ["Figma", "UI/UX"],
      figma:
        "https://www.figma.com/design/iCro6clVrG8LhanHkxHZ1G/GPAY?node-id=0-1&t=E93jiEWt4tYuMlhk-1",
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    <p className="text-lg leading-relaxed">
                      Hi, I’m Ebin, an aspiring computer engineer and BTech
                      Computer Science student with a strong interest in UI/UX
                      design, web development, and modern digital experiences. I
                      enjoy creating clean, user-friendly interfaces and
                      bringing ideas to life through thoughtful design and
                      efficient code.
                    </p>
                    <p className="text-lg leading-relaxed">
                      I have a foundation in Python, React, and web
                      technologies, along with hands-on experience working on
                      projects like Instagram-inspired prototypes and personal
                      portfolio websites.
                    </p>
            ...
            <section id="contact" className="py-20 bg-accent/20">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    Have a project in mind or just want to get in touch? I'd
                        ...
                        >
                          ...
                          <div className="flex flex-col items-center">
                            <Button
                              type="submit"
                              size="lg"
                              className="shadow-elegant group w-full"
                  ...
                  >
                    ...
                    <div className="space-y-9">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Ebin Reji's GitHub Profile"
                      >
                        <Card className="p-4 hover:bg-accent/50 hover:border-primary/30 transition-all duration-300 group">
                          <div className="flex items-center">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Ebin Reji's LinkedIn Profile"
                      >
                        <Card className="p-4 hover:bg-accent/50 hover:border-primary/30 transition-all duration-300 group">
                          <div className="flex items-center">
